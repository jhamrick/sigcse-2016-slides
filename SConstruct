...
env.Command(
    "sigcse-2016.slides.html",
    ["sigcse-2016.ipynb", "reveal.tpl", "reveal.js", "example/Assignment.html", "perceptron/Perceptron Demo.html"],
    " ".join([
        "jupyter nbconvert",
...
env.Alias("slides", "sigcse-2016.slides.html")
